...
import com.mvsk.mod.entity.MentorSkills;
...
import com.mvsk.mod.service.MentorSkillsService;
...
public class MentorSkillsController {
	...
	@ApiOperation(value = "Add mentor skill details", response = com.mvsk.mod.model.ApiResponse.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successfully performed the operation"),
	...
	public com.mvsk.mod.model.ApiResponse<?> addMentorSkill(
			@ApiParam(value = "Mentor Skill details which needs to add", required = true) @Valid @RequestBody MentorSkills mentorSkill) {

		return new com.mvsk.mod.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.mentor.skill.add"),
				mentorSkillService.addMentorSkill(mentorSkill));

	}

	@ApiOperation(value = "Update mentor skill details", response = com.mvsk.mod.model.ApiResponse.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successfully performed the operation"),
			@ApiResponse(code = 404, message = "Resource Not Found"),
			@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.mvsk.mod.model.ApiResponse<?> updateMentorSkill(
			@ApiParam(value = "Mentor Skill details which needs to update", required = true) @Valid @RequestBody MentorSkills mentorSkill) {

		return new com.mvsk.mod.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.mentor.skill.update"),
	...
	public com.mvsk.mod.model.ApiResponse<?> updateMentorTrainingCount(
		...
		return new com.mvsk.mod.model.ApiResponse<>(HttpStatus.OK.value(), null,
				mentorSkillService.updateMentorTrainingCount(mentorId, skillId));

	}

	@ApiOperation(value = "Delete mentor skill details", response = com.mvsk.mod.model.ApiResponse.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successfully performed the operation"),
			@ApiResponse(code = 404, message = "Resource Not Found"),
			@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.mvsk.mod.model.ApiResponse<?> deleteMentorSkill(
		...
		return new com.mvsk.mod.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.mentor.skill.delete"));
