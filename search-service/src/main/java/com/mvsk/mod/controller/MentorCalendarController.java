...
import com.mvsk.mod.model.MentorCalendarDtls;
import com.mvsk.mod.service.MentorCalendarService;
...
public class MentorCalendarController {
	...
	@ApiOperation(value = "Add calendar entry for specific mentor", response = com.mvsk.mod.model.ApiResponse.class)
	@ApiResponses(value = {
	...
	public com.mvsk.mod.model.ApiResponse<?> addCalendarEntry(
		...
		return new com.mvsk.mod.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.mentor.calendar.add"),
